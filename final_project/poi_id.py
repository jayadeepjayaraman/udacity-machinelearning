...
def transform_pca_pipeline(clf_list):
    ...
    for i in range(len(clf_list)):
        ...
        clf_list[i] = (Pipeline([("scaler",scaler),("pca", pca), (name, clf)]), new_params)
...
#ordered_list, summary_list = evaluation_loop(features, labels, pca_pipeline = True, num_iters=10, test_size=0.6)
...
clf = Pipeline(steps=[("scaler",scaler),("pca", pca), ("logistic", clf_logistic)])
